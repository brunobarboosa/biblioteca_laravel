...
<body>
    <div class="h-screen w-screen bg-fuchsia-300 flex items-center justify-center">
        <div class="h-3/5 w-1/4 bg-neutral-200 rounded-lg p-8 flex items-center font-sans flex-col">
                ...
                <div class="flex flex-col mt-6 h-full">
                    <div>
                        ...
                        <input type="text" name="nome"
                            class="h-8 w-full rounded-sm border-b-2 border-fusbg-fuchsia-300 bg-white">
